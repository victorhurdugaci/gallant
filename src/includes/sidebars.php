...
function register_theme_sidebars() {
    ...
    register_sidebar(array(
        'id'              => Sidebars::AboveContent,
        'name'            => __('Above Content', 'gallant'),
        'description'     => __('The sidebar displayed above posts and articles.', 'gallant'),
        'before_widget'   => '<div class="widget">',
        'after_widget'    => '</div>',
        'before_title'    => '<h4 class="widget-title">',
        'after_title'     => '</h4>'
    ...
    register_sidebar(array(
        'id'              => Sidebars::BelowContent,
        'name'            => __('Below Content', 'gallant'),
        'description'     => __('The sidebar displayed under posts and articles.', 'gallant'),
        'before_widget'   => '<div class="widget">',
        'after_widget'    => '</div>',
        'before_title'    => '<h4 class="widget-title">',
        'after_title'     => '</h4>'
...
abstract class Sidebars {
    const Right = 'right';
    const Footer = 'footer';
    const AboveContent = 'abovecontent';
    const BelowContent = 'belowcontent';
}
?>