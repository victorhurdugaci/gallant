...
function options_live_preview()
{
	wp_enqueue_script( 
		...
		get_template_directory_uri().'/js/options-livepreview.js',
...
function register_settings_ui($wp_customize) {
    ...
    $wp_customize->add_control(new WP_Customize_Control($wp_customize, Theme_Options::DISABLE_AUTHOR, array(
     ...
     $wp_customize->add_control(new WP_Customize_Control($wp_customize, Theme_Options::DISABLE_TAGS, array(
        'section'     => $appearance_section,
        'settings'    => Theme_Options::DISABLE_TAGS,
        'label'       => __('Disable tags', 'gallant'),
        'description' => __('Hides tags on posts.', 'gallant'),
        'type'        => 'checkbox'
    )));
...
function register_settings($wp_customize) {    
    ...
    $wp_customize->add_setting(Theme_Options::DISABLE_TAGS , array(
        'default'           => false,
        'sanitize_callback' => 'sanitize_boolean'
    ));
...
abstract class Theme_Options {
    ...
    const DISABLE_TAGS = 'disable_tags';
